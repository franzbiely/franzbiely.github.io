          ...
          <div className="feedback-container">
            <div className="comment-section">
              ...
              <span className="commentText">
                ...
                <br />
                One of the best Engineer I've work with. Knowledge and skills
                are superb with excellent eye on quality
        ...
        <Slide index={0}>
          <div className="comment-section">
            ...
            <span className="commentText">
              ...
              colleague. As he's highly skilled in web development and full
              stack development, he always loves to share knowledge and help.
              I'm very lucky working with Francis.
            </span>
          </div>
        </Slide>
        <Slide index={0}>
          <div className="comment-section">
            ...
            <span className="commentText">
              ...
              <br />
              Francis is a team player, technically very competent and is able
