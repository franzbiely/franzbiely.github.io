...
class slideShow {
  init($url, $url2) {
    ...
    l1.load(
      "https://raw.githubusercontent.com/manongfatu/artificer-images/master/justin.png",
      function(img) {
        slide.setImage(img);
      }
    );
    ...
    l2.load(
      "https://raw.githubusercontent.com/manongfatu/artificer-images/master/robert.png",
      function(img) {
        slide2.setImage(img);
      }
    );
...
var memberSlideShow = new slideShow();
window.onload = memberSlideShow.init();
