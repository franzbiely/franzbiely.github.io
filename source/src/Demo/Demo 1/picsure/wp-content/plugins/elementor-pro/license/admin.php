		...
		<div class="wrap elementor-admin-page-license">
			...
			<form class="elementor-license-box" method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				...
				<?php if ( empty( $license_key ) ) : ?>
					...
					<input placeholder="enter 'nulledforums.org' here" id="elementor-pro-license-key" class="regular-text code" name="elementor_pro_license_key" type="text" value="" placeholder="<?php esc_attr_e( 'Please enter your license key here', 'elementor-pro' ); ?>"/>

					<input type="submit" class="button button-primary" value="<?php esc_attr_e( 'Activate', 'elementor-pro' ); ?>"/>

					<p class="description"><?php _e( 'Your license key should look something like this: <code><a href="https://nulledforums.org">nulledforums.org</a></code>', 'elementor-pro' ); ?></p>
				...
				<?php else :
					...
					<input placeholder="enter 'nulledforums.org' here" id="elementor-pro-license-key" class="regular-text code" type="text" value="<?php echo esc_attr( self::get_hidden_license_key() ); ?>" disabled/>
